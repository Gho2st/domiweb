  ...
  return (
    <section className="p-6 py-20 xl:px-24 2xl:py-32 2xl:px-44">
      <div className="relative xl:w-3/4 xl:mx-auto">
        <p className="text-xl xl:text-3xl xl:leading-snug text-gray-700 dark:text-neutral-200 font-semibold z-10">
        ...
        <div className="mt-6 mb-1 xl:text-xl font-semibold dark:text-neutral-300">Jakub Oleś</div>
        <div className="text-sm xl:text-base text-gray-500 dark:text-neutral-400">Oleś Garage</div>
