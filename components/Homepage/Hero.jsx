    ...
    <section className="">
      <div className="relative px-6 min-h-[100vh] lg:px-24 2xl:px-44  ">
        ...
        <div className="lg:w-4/5 xl:w-9/12">
          <h2 className="mt-6 font-semibold text-4xl capitalize lg:text-5xl lg:leading-snug 2xl:text-6xl 2xl:leading-snug dark:text-neutral-100 ">
            Nowoczesne Strony i Aplikacje Mobilne – Wysokiej Jakości User
            Experience
          </h2>

          <p className="my-7 xl:my-10 text-neutral-900 dark:text-neutral-400 text-base font-light xl:text-xl 2xl:text-2xl   ">
