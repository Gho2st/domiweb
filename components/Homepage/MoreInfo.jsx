...
export default function MoreInfo() {
  return (
    <section className="p-6">
      <h2 className="capitalize mb-12 text-2xl font-semibold">
      ...
      <div className="my-10">
        ...
        <h3 className="text-lg font-medium">Kompleksowe usługi od A do Z</h3>
        <p className="mt-4 text-neutral-900 font-light">
          ...
          hostingu, przez projektowanie graficzne, aż po kodowanie i wdrożenie.
          W DomiWeb otrzymujesz pełne wsparcie na każdym etapie tworzenia.
        </p>
      </div>
      {/* card 2 */}
      <div className="my-10">
        ...
        <p className="mt-4 text-neutral-900 font-light">
          ...
          indywidualnie, dostosowując go do potrzeb klienta i specyfiki branży,
          aby Twoja strona wyróżniała się na tle konkurencji i odzwierciedlała
      ...
      <div className="my-10">
        ...
        <p className="mt-4 text-neutral-900 font-light">
          ...
          wyszukiwarkach. W DomiWeb stosujemy skuteczne techniki SEO, aby pomóc
          Ci zdobywać nowych klientów i zwiększać widoczność Twojej strony w
          Google.
        </p>
      </div>
      {/* card 4 */}
      ...
      <div className="my-10">
        ...
        <h3 className="text-lg font-medium">Nowoczesne technologie</h3>
        <p className="mt-4 text-neutral-900 font-light">
          Korzystamy z nowoczesnych technologii, aby zapewnić naszym klientom
          szybkie, bezpieczne i responsywne strony internetowe. W DomiWeb zawsze
          jesteśmy na bieżąco z trendami, co pozwala nam tworzyć rozwiązania o
          najwyższej jakości.
        </p>
      </div>
      ...
      <div className="my-10">
        ...
        <p className="mt-4 text-neutral-900  font-light">
          Po zakończeniu projektu nadal jesteśmy do Twojej dyspozycji. Oferujemy
          stałe wsparcie techniczne i opiekę nad stroną, abyś mógł skupić się na
          rozwijaniu swojej działalności, a nie na problemach technicznych.
        </p>
      </div>
    </section>
  );
